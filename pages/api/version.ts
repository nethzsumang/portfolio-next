...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  res.status(200).json({
    version: '1.16.1',
    since: '2024-02-12 22:05:00 UTC+0800',
    ...
    changelog: [
      ...
      },
      {
        ...
        changes: [
          'Update resume.',
          'Add entry description and language in history.'
        ]
      },
      {
        version: '1.15.3',
      ...
      },
      {
        ...
        changes: [
          'Fix History Record with Show More with background not the same as the container.'
        ]
      },
      {
        version: '1.15.1',
